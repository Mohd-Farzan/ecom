...
export const FatchAllFilterProduct=createAsyncThunk('products/FatchAllFilterProduct',
    ...
    const result=await axios.get(`https://the-lawncollection.onrender.com/api/shop/products/get?${query}`)
    return result?.data;
})
...
export const fetchProductDetails=createAsyncThunk('products/fetchProductDetails',
    async (id)=>{
        // console.log(id,'id')
    const result=await axios.get(`https://the-lawncollection.onrender.com/api/shop/products/get/${id}`)
    return result?.data;
})
