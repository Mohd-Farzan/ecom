...
function ShopingHeader() {
  ...
  console.log('categoryOptionMap:', categoryOptionMap);
  console.log('categoryunStitchedMap:', categoryunStitchedMap);
              ...
              {(categoryOptionMap || []).map((item) => (
                <li key={item.id}>
                  <NavigationMenuLink asChild>
                    ...
                    >
                      <div onClick={() => handleNavigate(item)} className="text-sm font-medium leading-none">
                        {item.label}
                      </div>
                    </Link>
                  </NavigationMenuLink>
